...
from transformers import AutoConfig, AutoModelForCausalLM, AutoTokenizer, Trainer, TrainingArguments, logging, set_seed, LlamaTokenizer
...
def main(args):
    ...
    tokenizer = LlamaTokenizer.from_pretrained(args.model_path, use_auth_token=False)
